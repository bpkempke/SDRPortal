...
private:
    ...
    void send_reg(boost::uint8_t addr){
        ...
        printf("XCVR@%p: send value 0x%05x\n",(void*)(this->get_iface().get()),value);
...
void xcvr2450::update_atr(void){
    ...
    printf("tx_ant_sel = %04x rx_ant_sel = %04x\n",tx_ant_sel,rx_ant_sel);
